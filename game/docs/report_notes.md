...
- If money is low and no loan is active, take a loan.
- Otherwise, continue the sprint.
...
The three RL models satisfy the requirement to compare at least three learning approaches.
