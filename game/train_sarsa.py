...
def main():
    ...
    with open("final_sarsa_model.json", "w", encoding="utf-8") as file:
    ...
    save_metrics_json(
        {
            ...
            "final_model_path": "final_sarsa_model.json",
        },
    ...
    print("Saved final SARSA model to: final_sarsa_model.json")
